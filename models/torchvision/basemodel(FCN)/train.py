...
if __name__ == "__main__":
    ...
    parser.add_argument('--model_name', type=str, default='MODEL_NAME', help='Name of the segmentation model')
    parser.add_argument('--json_dir', type=str, default='JSON_PATH', help='train_valid_split_dir')
...
train(model, train_loader, valid_loader, criterion, optimizer, args.epochs, args.val_every, args.saved_dir)
